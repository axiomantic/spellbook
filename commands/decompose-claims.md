---
description: "Decompose text into atomic, independently verifiable claims using FActScore-style analysis. For text and documentation claims only; code claims use inline verification."
---
