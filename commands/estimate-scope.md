---
description: Phase 1-3 of estimating-tickets. Ingest the test card, validate external-domain constraints, build a structural repo map, decompose into tickets tagged by repo.
---
