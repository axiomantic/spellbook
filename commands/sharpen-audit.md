---
description: "Audit LLM prompts/instructions for ambiguity. Use when reviewing prompts, skill instructions, subagent prompts, or any AI-targeted text. Produces findings report with severity, executor predictions, and remediation."
---
