---
description: "Rewrite LLM prompts to eliminate ambiguity. Use when you have a prompt that needs sharpening and authority to modify it. Produces improved prompt with change log. Asks clarifying questions when context insufficient."
---
