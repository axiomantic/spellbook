...
"Generate per-task emotional stakes (EmotionPrompt + NegativeReinforcement) with task-appropriate professional personas. Improves accuracy and truthfulness based on research."
