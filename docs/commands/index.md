...
|---------|-------------|--------|
| [/address-pr-feedback](address-pr-feedback.md) | description: | | spellbook |
...
| [/crystallize](crystallize.md) | description: | | spellbook |
| [/distill-session](distill-session.md) | description: "Distill oversized session: extract context, workflow, pending work... | spellbook |
| [/execute-plan](execute-plan.md) | description: | | [superpowers](https://github.com/obra/superpowers) |
