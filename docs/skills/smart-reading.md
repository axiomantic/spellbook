...
> Full protocol for reading files or command output of unknown size: measure before reading, never truncate blindly, delegate large reads. Loaded by the file-reading rule module, which carries the one-line rule and points here.
## Skill Content
