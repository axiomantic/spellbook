...
const HIGH_CONFIDENCE_PATTERNS = [
  ...
  },
  {
    ...
    confidence: 95,
    defaultCategory: 'SAFE_TO_SKIP',
    description: 'Matches lines containing print statements (additions or removals)',
    priority: 'high',
    matchLine: /^\s*print\(/,
  },
  {
    ...
    confidence: 95,
    defaultCategory: 'SAFE_TO_SKIP',
    description: 'Matches lines containing import statements (additions or removals)',
    priority: 'high',
