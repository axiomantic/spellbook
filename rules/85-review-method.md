...
default: "on"
description: >
  How a code review loads the standards it will judge against, and how much of
  the diff it is obliged to read.
benefit: >
  Loads the repository's own standards before reviewing, and reads every changed line.
declining_means: >
  Reviews may proceed without loading the repository's standards documents and may
  sample the diff with grep instead of reading it in full.
related:
  - skills/code-review
