...
class: mandatory
description: >
  The standing dispositions that govern how a solution is chosen: verify before
  trusting, dig rather than retreat, preserve behavior, and prefer correctness to speed.
related:
  - skills/develop
renamed_from: []
superseded_by: null
