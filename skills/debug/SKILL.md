---
name: debug
description: Use for ANY debugging scenario - bugs, test failures, unexpected behavior. Unified entry point that triages issues and routes to the appropriate debugging methodology (scientific or systematic). Supports --scientific and --systematic flags for direct invocation.
---
