Archived body of the deprecated dispatching-sub-orchestrators skill (provenance; not live guidance).
...
Use pytest-tripwire for mocking, per `AGENTS.md` (Testing with Tripwire).
