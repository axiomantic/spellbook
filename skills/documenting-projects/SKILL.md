...
description: >-
  Use when generating, improving, or auditing project documentation. Triggers:
  'document this project', 'write docs', 'generate documentation', 'docs are
  outdated', 'need a README', 'create tutorials', 'API reference docs',
  'doc audit', 'documentation review'. Standalone README:
  use /write-readme. NOT for: code changes (use develop), code review (use
  code-review), or research (use deep-research).
intro: >-
  ...
  guide rules. Invoke by name, or describe your documentation
  needs, and this skill manages the full pipeline from audit through reviewed
  delivery via `/docs-audit`, `/docs-plan`, `/docs-write`, and `/docs-review`. For standalone README generation, use `/write-readme` instead.
---
