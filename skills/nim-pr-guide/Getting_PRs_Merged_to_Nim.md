...
Research based on analysis of 154 PRs merged by Araq (BDFL) from external contributors in the nim-lang/Nim repository.
...
From PR #25377:
- Araq requested: "Can I get some before/after screenshots please?"
...
From PR #25317:
- Araq: "Document somewhere (ideally in the manual) what affects this has and what kind of subtyping this allows for."
...
**Why:** Araq commented: "I hate this shit. Just make the compiler emit copyMem..."
...
- **Merge time:** 50 days
- **Issue:** Optimization workaround instead of fixing root cause - Araq pushed back hard
