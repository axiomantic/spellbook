...
description: Use when designing multi-step processes, state machines, approval workflows, pipelines, or any system with explicit states and transitions. Triggers include "workflow", "state machine", "pipeline", "approval flow", "process design", or requests involving sequential stages with conditions.
---
