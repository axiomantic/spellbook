...
Session and swarm management tools for Claude Code via Model Context Protocol.

## Overview

The Spellbook MCP server provides tools for session discovery and swarm coordination:
