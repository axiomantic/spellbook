...
class TestRun:
    ...
    def test_config_set_then_get(self, tmp_path, capsys):
        """Set a value, then get it back."""
        config_file = tmp_path / "spellbook.json"
        config_file.write_text("{}")

        get_config_path_mock = tripwire.mock("spellbook.cli.commands.config:get_config_path")
        get_config_path_mock.always_returns(config_file)
        # Also patch the config module's get_config_path for config_set/config_get
        get_config_path_mock2 = tripwire.mock("spellbook.core.config:get_config_path")
        get_config_path_mock2.always_returns(config_file)
        ...
        get_config_path_mock2.assert_call(args=(), kwargs={})
        get_config_path_mock2.assert_call(args=(), kwargs={})

    def test_config_get_all_json(self, tmp_path, capsys):
    ...
    def test_config_get_missing_key(self, tmp_path, capsys):
    ...
    def test_config_get_no_config_file(self, tmp_path, capsys):
