"""Tests for spellbook.security.rules module.
...
class TestFindingDataclass:
    ...
    def test_finding_creation(self):
        from spellbook.security.rules import Category, Finding, Severity
        f = Finding(
            file="test.md",
            line=1,
...
class TestScanResultDataclass:
    ...
    def test_scan_result_defaults(self):
        from spellbook.security.rules import ScanResult
...
class TestExfiltrationRules:
    ...
    def test_exfiltration_rules_exist(self):
        from spellbook.security.rules import EXFILTRATION_RULES
...
class TestEscalationRules:
    ...
    def test_escalation_rules_exist(self):
        from spellbook.security.rules import ESCALATION_RULES
...
class TestObfuscationRules:
    ...
    def test_obfuscation_rules_exist(self):
        from spellbook.security.rules import OBFUSCATION_RULES
...
class TestShannonEntropy:
    ...
    def test_empty_string_returns_zero(self):
        from spellbook.security.rules import shannon_entropy
...
class TestTrustLevels:
    ...
    def test_trust_levels_exist(self):
        from spellbook.security.rules import TRUST_LEVELS
...
class TestCheckPatterns:
    ...
    def test_detects_curl_exfiltration(self):
        from spellbook.security.rules import EXFILTRATION_RULES, check_patterns
    ...
    def test_detects_rm_rf(self):
        ...
        alias should work.
        """
        from spellbook.security.rules import ESCALATION_RULES, check_patterns
...
class TestSecurityModes:
    ...
    def test_paranoid_flags_medium_severity(self):
        ...
        from spellbook.security.rules import INJECTION_RULES, Severity, check_patterns
...
class TestModuleImports:
    ...
    def test_init_re_exports(self):
        ...
        from spellbook.security import (
            INJECTION_RULES,
            EXFILTRATION_RULES,
            ESCALATION_RULES,
            OBFUSCATION_RULES,
