...
from spellbook.terminal_utils import (
    detect_terminal,
...
class TestDetectTerminal(unittest.TestCase):
    ...
    @patch('spellbook.terminal_utils.detect_macos_terminal')
    @patch('sys.platform', 'darwin')
    ...
    @patch('spellbook.terminal_utils.detect_linux_terminal')
    @patch('sys.platform', 'linux')
    ...
    @patch('spellbook.terminal_utils.detect_windows_terminal')
...
class TestSpawnTerminalWindow(unittest.TestCase):
    ...
    @patch('spellbook.terminal_utils.spawn_macos_terminal')
    @patch('sys.platform', 'darwin')
    ...
    @patch('spellbook.terminal_utils.spawn_linux_terminal')
    @patch('sys.platform', 'linux')
    ...
    @patch('spellbook.terminal_utils.spawn_windows_terminal')
    @patch('sys.platform', 'win32')
...
class TestSpawnClaudeSessionMCPTool(unittest.TestCase):
    ...
    @patch('spellbook.terminal_utils.detect_terminal')
    @patch('spellbook.terminal_utils.spawn_terminal_window')
